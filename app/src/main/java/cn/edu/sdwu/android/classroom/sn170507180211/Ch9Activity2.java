...
public class Ch9Activity2 extends AppCompatActivity {
    ...
    class  MyAdapter extends BaseExpandableListAdapter{
        ...
        @Override
        public Object getChild(int i, int i1) { //参数第几类别的第几产品
            //得到二级数据
            String cat=category.get(i).toString();//得到类别
            ArrayList prolist=(ArrayList) product.get(cat);
        ...
        public View getGroupView(int i, boolean b, View view, ViewGroup viewGroup) {
            //得到一级数据的视图
            //为了提高运行效率 ，系统将之前使用的View对象传回，我们可以重复利用，避免每次实例化新对象
            if(view==null){
        ...
        public View getChildView(int i, int i1, boolean b, View view, ViewGroup viewGroup) {
            ...
            if (view==null){
                LayoutInflater layoutInflater=getLayoutInflater();
                view=layoutInflater.inflate(R.layout.layout_gools,null);
            }
            //设置产品的内容
    ...
    private void initData(){
        //准备数据，实际情况下，可能来自数据库后网络（调用模型层的功能）
