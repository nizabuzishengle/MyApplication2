...
public class Ch7Activity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hashMap.put("img",R.drawable.fengjing);
        list.add(hashMap);
        hashMap=new HashMap();
        ...
        list.add(hashMap);
        //实例化适配器
        simpleAdapter=new SimpleAdapter(this,list,R.layout.layout_gools,new String[]{"name","price","img"},new int[]{R.id.goods_name,R.id.goods_price,R.id.goods_img});
        //
